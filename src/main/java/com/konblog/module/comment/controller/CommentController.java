...
public class CommentController {
    ...
    @GetMapping("/user/article/{articleId}") public Result<List<Comment>> listByArticle(@PathVariable Long articleId) { return Result.success(commentService.listByArticle(articleId)); }
    ...
    @GetMapping("/admin/list") @SaCheckRole("admin") public Result<List<Comment>> adminList() { return Result.success(commentService.listAll()); }
